...
namespace Cortex
{
    ...
    public:
        ...
        Orthotope3(const Vector3<T> &center, const T length) : low_(center - (Vector3<T>)(length)), high_(center + (Vector3<T>)(length))
        {
        }
        ...
        {
            return (pos.x < low_.x) || (high_.x <= pos.x) || (pos.y < low_.y) || (high_.y <= pos.y) || (pos.z < low_.z) || (high_.z <= pos.z);
        }
        ...
        unsigned int notContained(const Orthotope3 &a) const
        {
            ...
            return (a_high.x < b_low.x) || (b_high.x <= a_low.x) || (a_high.y < b_low.y) || (b_high.y <= a_low.y) || (a_high.z < b_low.z) || (b_high.z <= a_low.z);
        }
        ...
        {
            return (a.high_.x < low_.x) || (high_.x < a.low_.x) || (a.high_.y < low_.y) || (high_.y < a.low_.y) || (a.high_.z < low_.z) || (high_.z < a.low_.z);
        }
