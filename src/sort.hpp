...
#pragma omp parallel for
    ...
    */
                              ...
                              Tpred pred)
    {
        ...
        RandomSampling(val, smp, [](const T &src, T &dst)
                       { dst = src; });
...
#pragma omp for
    ...
    */
    ...
    inline void MergeSortOmpImpl(T *first0, T *last0, T *first1, T *last1, T *res, Tpred pred)
    {
        ...
        const auto n = n0 + n1;
#if defined(CORTEX_THREAD_PARALLEL)
